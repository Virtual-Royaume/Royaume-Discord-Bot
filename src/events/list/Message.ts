...
import Member, { MemberChannelsMessageCount } from "../../database/src/models/Member";
...
export default class Message extends Event {
    ...
    public async run(message: Msg) : Promise<void> {
        ...
        const columnOfChannel = Member.channelIDToPropertyName[message.channel.id] as keyof MemberChannelsMessageCount
