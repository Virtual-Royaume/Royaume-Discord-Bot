...
export type TgmQueryVariables = Exact<{ [key: string]: never; }>;


export type TgmQuery = { __typename?: 'Query', members: Array<{ __typename?: 'Member', _id: string } | null> };


export const TgmDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"Tgm"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"members"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"_id"}}]}}]}}]} as unknown as DocumentNode<TgmQuery, TgmQueryVariables>;